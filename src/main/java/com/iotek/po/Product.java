...
public class Product {
    public   static  final  int   PRODUCT_IS_DELETED=1; //��ɾ��
    public   static  final  int   PRODUCT_IS_NOT_DELETED=0; //δɾ��
    public   static  final  int   PRODUCT_IS__DELETED_DEFLULT=PRODUCT_IS_NOT_DELETED; //Ĭ��ֵδɾ��
    private  Integer  id;
